...
<head>
	...
	<link rel="stylesheet" href="rear-top-800.css">
	<link rel="preconnect" href="https://fonts.googleapis.com">
	<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
	<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
	<title>rear-top-800</title>
</head>
<body>
	<div class="main-content">
		<div class="image-div cell" onclick="addCoords(event);">
			<svg>
				<path d="M 64 142 L 404 146 L 404 554 L 64 538 Z" />
				<path d="M 1280 142 L 1830 144 Q 1854 466, 1688 718 Q 1468 656, 1280 624 Z" />
			</svg>
		</div>
